...
const USER_STATS: UserStats = {
  ...
  level: {
    current: 42,
    title: 'Premium Cinephile',
    progress: 75,
    nextLevel: 'Elite Cinephile',
  },
};
        ...
        <View style={styles.header}>
          <View style={styles.profileInfo}>
            ...
            <View style={styles.levelContainer}>
              ...
              <Text style={styles.levelText}>Level {USER_STATS.level.current}</Text>
            ...
            <Text style={styles.levelInfo}>
              {USER_STATS.level.progress}% for {USER_STATS.level.nextLevel}
            </Text>
          </View>
        </View>
